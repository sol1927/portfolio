  ...
  return (
    ...
    >
      ...
      <p className="text-glow-2 text-base sm:text-2xl font-semibold p-4 text-center">
        Here are some of the projects I have worked on, showcasing my skills in web development and software engineering.
      </p>

      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-4 m-4">
        <div className="group relative w-full aspect-[16/9] lg:h-80 rounded-lg overflow-hidden hover:-translate-y-2 transition-all duration-700 shadow-gray-700 shadow-[10px_10px_10px_2px] hover:shadow-blue-500">
          <Image
          ...
          <div className="absolute inset-0 flex items-end justify-center px-2 pb-3 sm:px-4 sm:pb-4">
            <a href="https://solomonaragaw.vercel.app/" target="_blank" rel="noopener noreferrer">
              <button className="bg-blue-950 text-white px-3 sm:px-4 py-2 text-sm sm:text-base rounded-full group-hover:scale-110 hover:scale-115 shadow-gray-700 shadow-[10px_10px_10px_2px] hover:shadow-blue-500 hover:shadow-[0px_-10px_10px_5px] transition-all duration-300">
                Portfolio Website
              </button>
            </a>
          </div>
        ...
        <div className="group relative w-full aspect-[16/9] lg:h-80 rounded-lg overflow-hidden hover:-translate-y-2 transition-all duration-700 shadow-gray-700 shadow-[10px_10px_10px_2px] hover:shadow-blue-500">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
          <div className="absolute inset-0 flex items-end justify-center px-2 pb-3 sm:px-4 sm:pb-4">
            <a href="https://gibigebeta.vercel.app/" target="_blank" rel="noopener noreferrer">
              <button className="bg-blue-950 text-white px-3 sm:px-4 py-2 text-sm sm:text-base rounded-full group-hover:scale-110 hover:scale-115 shadow-gray-700 shadow-[10px_10px_10px_2px] hover:shadow-blue-500 hover:shadow-[0px_-10px_10px_5px] transition-all duration-300">
                GibiGebeta
              </button>
            </a>
