      ...
      <div id="header" className='flex flex-col items-center p-4 pt-32'>
        ...
        <div className='flex flex-col items-center text-center m-6 gap-6'>
          ...
          <div className='flex flex-col sm:flex-row m-2 p-4 gap-4 sm:gap-8 md:gap-20 items-center justify-center'>
            ...
            >
              <button className='flex items-center justify-center gap-2 shadow-gray-700 shadow-[10px_10px_10px_2px] bg-green-600 py-3 px-6 rounded-2xl hover:cursor-pointer hover:scale-110 hover:shadow-blue-600 transition-all duration-300' onClick={viewResume} >View Ressssume <span><LuDownload className='w-5 h-5' /></span></button>
            </motion.div>
          </div>
        </div>
      </div>
